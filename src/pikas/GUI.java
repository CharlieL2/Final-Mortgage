...
public class GUI extends JPanel implements DocumentListener {
	...
	public GUI() {
		...
		grossIncomeField.getDocument().addDocumentListener(this);
	...
	//code just to take the values and push them into the engine
	private void Calc() {
		...
		housePayField.setText(String.valueOf(currencyFormat.format(values.getHousePay())));
	...
	//sets up the format for the fields
